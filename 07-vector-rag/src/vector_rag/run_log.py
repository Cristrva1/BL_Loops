"""Eventos JSONL sin contenido crudo de preguntas, fuentes o respuestas."""
...
class RunLogger:
    ...
    def emit(
        ...
        *,
        ...
        event = {
            ...
            "lab_id": "07-vector-rag",
            "variant_id": "hybrid-fts5-qwen3",
            "case_id": "I-RAG-VECTOR-005@0.1.0",
            "model": self._model,
    ...
    def finish(self, status: str, reason: str, *, sources: int) -> None:
        if self._finished:
            return
        self.emit(
