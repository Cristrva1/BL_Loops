...
class OllamaError(RuntimeError):
    """Error seguro y explicable al conversar con Ollama."""
...
class _NoRedirectHandler(HTTPRedirectHandler):
    """Convierte toda redireccion en error para no abandonar el endpoint local."""
...
class OllamaClient:
    """Envia historial de chat y devuelve exclusivamente la respuesta final."""
    ...
    def __init__(
        ...
        # No heredar HTTP_PROXY/HTTPS_PROXY: el chat debe ir directo a localhost.
    ...
    def chat(self, messages: list[dict[str, str]]) -> ChatResult:
        ...
        request = Request(
            ...
            headers={"Content-Type": "application/json", "User-Agent": "BL-Loops-Single-Agent/0.1"},
            method="POST",
        )
